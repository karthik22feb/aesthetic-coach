...
| **Status** | Backend Authentication module (Sprint 1, Tasks 9–16) **complete** and merged to `main`, tagged `v1.0.0-auth-complete`. Flutter mobile foundation (Tasks 5–7: project scaffold, Riverpod/go_router, mobile CI) implemented and verified on `feature/flutter-foundation`, pending merge. |
...
| **Next Task** | Review/merge `feature/flutter-foundation`, then Flutter Login/Signup screens (Task 17) — see [NEXT_TASK.md](NEXT_TASK.md) |

...
**Last updated:** 2026-08-13 · **Updated by:** Flutter mobile foundation (Sprint 1, Tasks 5–7) — project scaffold, Riverpod/go_router skeleton, mobile CI implemented and verified on `feature/flutter-foundation`, pending merge
...
| Repository / codebase | 🟡 In progress — Laravel backend scaffolded; register/login/logout merged and hardened; Flutter scaffold + Riverpod/go_router + mobile CI on `feature/flutter-foundation`, pending merge |
